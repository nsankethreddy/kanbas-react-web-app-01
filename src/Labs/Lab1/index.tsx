  ...
  return (
    <div id="wd-lab1">
      ...
      <div id="wd-p-tag">
        ...
        <h5>Ordered List of favourite recipes</h5>
        My favourite recipe:å
        <ol id="wd-your-favorite-recipe">
          <li>Get half cup of warm water.</li>
          <li>Put one spoon of coffee.</li>
          <li>Stir to combine.</li>
          <li>Add some milk in it.</li>
          <li>Put it in microwave for 2 minutes.</li>
          <li>Stir it again.</li>
          <li>Serve and enjoy!</li>
        </ol>
      ...
      <div id="wd-images">
        ...
        <br />
        <img id="wd-teslabot" src="images/course1.jpg" height="200px" />
      </div>
      <div id="wd-forms">
        <h4>Form Elements</h4>
      ...
      <br />
      Please
      <a id="wd-github" href="https://github.com/nsankethreddy/kanbas-react-web-app">
        {" "}
        click here
      </a>
      to go to the git repo
      <br />
    </div>
  );
}
