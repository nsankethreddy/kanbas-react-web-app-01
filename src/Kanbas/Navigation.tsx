...
export default function KanbasNavigation() {
  return (
    <div id="wd-kanbas-navigation">
      <ul>
        <li><a href="https://www.northeastern.edu/" id="wd-neu-link" target="_blank" rel="noopener noreferrer">Northeastern</a></li>
        ...
        <li><Link to="/Kanbas/Courses/index" id="wd-course-link">Courses</Link></li>
