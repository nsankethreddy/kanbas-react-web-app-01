...
export default function ModulesControls({ moduleName, setModuleName, addModule, isFaculty }:
        ...
        <div id="wd-modules-controls" className="text-nowrap">
            ...
            {isFaculty && (
                <div className="dropdown d-inline me-1 float-end">
                    <button id="wd-publish-all-btn" className="btn btn-lg btn-secondary dropdown-toggle d-flex align-items-center"
